...
#Serializador para los bjetos de tipo Genero
...
#Serializador para los bjetos de tipo Autor
...
#Serializador para los bjetos de tipo Editorial
...
#Serializador para los bjetos de tipo Libro
